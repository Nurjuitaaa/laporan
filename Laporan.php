...
echo 'Nama Produk: <input type="text" name="nama" required>';
echo 'Harga Per Produk: <input type="number" name="harga" required>';
echo 'Jumlah Terjual: <input type="number" name="jumlah" required>';
